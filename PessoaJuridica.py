...
class PessoaJuridica(Pessoa):
    ...
    def dataAberturaEmpresa(self, data):
        self.__dataAberturaEmpresa = data
    ...
    @cnpj.setter
    def cnpj(self, cnpj):
        if (len(cnpj) != 18): raise ValueError("O CNPJ deve conter 18 caracteres (no formado 00.000.000/0001-00).")
